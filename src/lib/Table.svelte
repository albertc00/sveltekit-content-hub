...
<div class="table-wrapper" bind:this={wrapperRef} style:max-height={`${maxHeight}px`}>
...
<style lang="scss">
	...
	.skeleton {
		...
		font-family: 'Lato', sans-serif;
		background: #eee;
		background: linear-gradient(110deg, #ececec71 8%, #e2e2e2a8 18%, #ececec8f 35%);
